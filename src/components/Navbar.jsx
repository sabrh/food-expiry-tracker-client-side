        ...
        <div className="navbar-end gap-4">
            ...
            <div className="flex items-center gap-4">
                ...
                className={({ isActive }) => isActive ? 
                    'underline text-gray-800 underline-offset-4 font-semibold' : ''}>
                LOGIN
                </NavLink>
                <NavLink to="/register" 
            ...
            <div className="dropdown dropdown-end">
                ...
                <div className="w-12 rounded-full border overflow-hidden cursor-pointer">
                ...
                <li>
                    <button onClick={handleLogout} className="btn btn-error text-white w-full">
                    LOGOUT
                    </button>
                </li>
                </ul>
